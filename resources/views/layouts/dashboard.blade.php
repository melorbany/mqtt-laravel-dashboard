 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">HMS | Home Management System</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('/accounts') ? 'class="active"' : '') }}>
                            <a href="{{ url ('/accounts') }}"><i class="fa fa-group fa-fw"></i> Accounts</a>
                        </li>
                        <li {{ (Request::is('/units') ? 'class="active"' : '') }}>
                            <a href="{{ url ('/units') }}"><i class="fa fa-gears fa-fw"></i> Units</a>
                        </li>
